...
import { 
    ...
    METAL_COLORS, COUNTRIES, TERRAINS, THREAT_SCALES, ORIGINS, ONI_POWER_LEVELS 
} from './constants';
      ...
      case 'Caçador':
        return (
          <>
            ...
            <Select label="Origem" value={filters.hunterOrigin} onChange={(e) => handleFilterChange('hunterOrigin', e.target.value)}>{ORIGINS.map(o => <option key={o} value={o}>{o}</option>)}</Select>
      ...
      case 'NPC':
        return (
          <>
            ...
            <Select label="Origem" value={filters.npcOrigin} onChange={(e) => handleFilterChange('npcOrigin', e.target.value)}>{ORIGINS.map(o => <option key={o} value={o}>{o}</option>)}</Select>
      ...
      case 'Forma de Respiração':
        return (
          <>
             ...
             <Select label="Origem do Usuário" value={filters.breathingFormOrigin} onChange={(e) => handleFilterChange('breathingFormOrigin', e.target.value)}>{ORIGINS.map(o => <option key={o} value={o}>{o}</option>)}</Select>
