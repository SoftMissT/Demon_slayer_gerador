...
export const FilterPanel: React.FC<FilterPanelProps> = ({ filters, onFiltersChange, onGenerate, isLoading }) => {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4 flex flex-col h-[calc(100vh-150px)]">
      <h2 className="text-xl font-bold text-white mb-4 font-gangofthree flex-shrink-0">Forja de Lendas</h2>
      ...
      <div className="mt-6 pt-4 border-t border-gray-700 flex-shrink-0">
        <div className="grid grid-cols-2 gap-2">
            ...
            <Button onClick={() => onGenerate(3)} disabled={isLoading} className="w-full" variant="secondary">
                <SparklesIcon className="w-5 h-5" />
                {isLoading ? '...' : 'Gerar x3'}
            </Button>
        </div>
