...
export const MidjourneyParameters: React.FC<MidjourneyParametersProps> = ({ params, onParamsChange, enabled, onEnabledChange }) => {
    ...
    const handleReset = () => {
        // FIX: Replaced dynamic loop with explicit property assignment to ensure type safety.
        // The previous loop caused a type mismatch because TypeScript couldn't infer the
        // specific generic type (string or number) for each parameter during iteration.
        onParamsChange({
